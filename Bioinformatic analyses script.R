...
CTCL_cluster <- c("CTCL_P1", "CTCL_P2", "CTCL_P3", "CTCL_P4", "CTCL_P5", "CTCL_P6", "CTCL_P7","CTCL_P8", "CTCL_P9", "CTCL_P10", "CTCL_P11")
...
#### add prefix ahead of barcode
data_S <- readRDS(file = "~/project/2021_CTCL_data/CTCL_subpopolation_investigation/20210329/Phate_subpopulations/rsd_file/P11_5P_U.rds")
barcode <- colnames(data_S)[which(data_S$subseted_cluster == "Normal_CD4T normal_clonotype1+")]
B_P1 <- paste("CTCL_Patients_P1", barcode,sep = "_")
B_P2 <- paste("CTCL_Patients_P2", barcode,sep = "_")
B_P3 <- paste("CTCL_Patients_P3", barcode,sep = "_")
B_P4 <- paste("CTCL_Patients_P4", barcode,sep = "_")
B_P5 <- paste("CTCL_Patients_P5", barcode,sep = "_")
B_P6 <- paste("CTCL_Patients_P6", barcode,sep = "_")
B_P7 <- paste("CTCL_Patients_P7", barcode,sep = "_")
B_P8 <- paste("CTCL_Patients_P8", barcode,sep = "_") 
B_P9 <- paste("CTCL_Patients_P9", barcode,sep = "_")
B_P10 <- paste("CTCL_Patients_P10", barcode,sep = "_")

CTCL_patient$phate_cluster_CTCL_patient[which(colnames(CTCL_patient) %in% c(B_P1, B_P2, B_P3, B_P4, B_P5, B_P6, B_P7,  B_P8, B_P9, B_P10 ))] <- "Normal_CD4T normal_clonotype1+"

CTCL_patient_2 <- CTCL_patient
saveRDS(CTCL_patient_2, file= file.path("~/project/2021_CTCL_data/CTCL_subpopolation_investigation/20210329/Integration/UMAP/","CTCL_patient_2_integrated.rds"))
